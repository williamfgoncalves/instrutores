...
angular.module('auth').factory('authService', function (appConfig, $http, $q, $location, $localStorage) {

  // Utiliza constant de configuração
  let urlUsuario = appConfig.urlBase + '/acessos/usuario';
  let urlLogin = appConfig.urlLogin;
  let urlPrivado = appConfig.urlPrivado;
  let urlLogout = appConfig.urlLogout;
  ...
  function login(usuario) {
    ...
    $http({
      ...
      function (response) {
        ...
        $localStorage.usuarioLogado = response.data.result;
